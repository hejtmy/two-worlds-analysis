...
There was also a difference between conditions in their pointing performance at the end of the first phase (`r apa_print(aov(abs_error ~ learning.condition, data = sub_sop_all))$statistic$learning_condition`), with both Treadmill VR group and the Desktop group performend significantly worse than the group in the real world.
```{r}
TukeyHSD(aov(abs_error ~ learning.condition, data = sub_sop_all))
```

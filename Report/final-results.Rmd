...
```{r}
ggplot(only_blocks(walk_all, 6), aes(x = condition, y = min_norm_distance, fill = learning.condition)) +
  stat_summary(fun.data=mean_cl_normal,position=position_dodge(0.95), geom="errorbar") + 
  stat_summary(fun.y=mean,position=position_dodge(width=0.95),geom="bar") +
...
ggplot(only_blocks(walk_all, 6), aes(x = condition, y = errors, fill = learning.condition)) +
  stat_summary(fun.data=mean_cl_normal,position=position_dodge(0.95), geom="errorbar") + 
  stat_summary(fun.y=mean,position=position_dodge(width=0.95),geom="bar") +

...
We also observed significant differences between conditions in pointing performance at the end of the first phase, `r apa_print(aov_point_phase1)$statistic$learning_condition`.  Specifically, participants in the real-world learning group  performed significantly better compared to both the immersive VR group `r m_sd_report(only_condition(point_data_1, "Real")$abs_error)`, t(df) = ##.##, p < .001) and the desktop group (`r m_sd_report(only_condition(point_data_1, "Desktop")$abs_error)`), t(df) = ##.##, p < .001). Overall, these findings suggested that participants learned the building the best as a result of real-world navigation, followed by the immersive condition, with the desktop condition showing the slowest acquisition.
